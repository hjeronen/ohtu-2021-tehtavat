...
public class Stepdefs {
    ...
    public void newUserHasBeenCreated(String username, String password) {
        newUserSelected();
    ...
    public void newAccountHasNotBeCreated(String username, String password) {
        newUserSelected();
        createNewUser(username, password, password);
        driver.get(baseUrl);
    }
    ...
    public void usernameDoesNotExist(String username, String password) throws Throwable {
        logInWith(username, password);
    }
    ...
    public void validUsernameAndPasswordGiven(String username, String password) throws Throwable {
        createNewUser(username, password, password);
    }
    ...
    public void invalidUsername(String username, String password) throws Throwable {
        createNewUser(username, password, password);
    }
    
    @Then("user is not created and error {string} is reported")
    public void userNotCreatedWithTooShortUsernameError(String errorMessage) {
    ...
    public void passwordConfirmationMismatch(String username, String password, String passwordconfirmation) throws Throwable {
