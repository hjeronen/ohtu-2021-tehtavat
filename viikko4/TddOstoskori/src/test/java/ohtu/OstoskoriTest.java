...
public class OstoskoriTest {
    ...
    @Test
    public void kahdestiSamanTuotteenLisayksenJaToisenPoistoJattaaKoriinYhdenKappaleenTuotetta() {
        Tuote maito = new Tuote("maito", 3);
        kori.lisaaTuote(maito);
        kori.lisaaTuote(maito);
        kori.poista(maito);
    ...
    @Test
    public void samanTuotteenLisayksenJaPoistonJalkeenKoriOnTyhja() {
        Tuote maito = new Tuote("maito", 3);
        kori.lisaaTuote(maito);
        kori.poista(maito);
    ...
    @Test
    public void tyhjennaKoriTyhjentaaKorin() {
        kori.lisaaTuote(new Tuote("maito", 3));
        kori.lisaaTuote(new Tuote("mehu", 4));
